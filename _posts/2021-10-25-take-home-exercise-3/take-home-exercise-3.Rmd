...
### 5.2.1 Visualising the relationships of the respective independent variables
...
```
### 5.2.3 Additional check for multicollinearity 
...
### 5.2.5 Test for Normality Assumption
...
## 7.3 Visualising Coefficient Standard Error (Intercept_SE)
...
Thank you for looking through this study and all the best in your property search!
