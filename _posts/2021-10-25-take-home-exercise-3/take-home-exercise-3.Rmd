---
title: "Hedonic Pricing Models for resale prices of Public Housing in Singapore"
description: |
...
```{r setup, include=FALSE, eval=TRUE, echo=TRUE, message=FALSE, error=FALSE, dpi=72, fig.retina=2}
...
We will build Hedonic Pricing Models using **the adaptive bandwidth** schemes.

## 7.1 Building Adaptive Bandwidth GWR Model

### 7.1.1 Computing adaptive bandwidth

We will first use *bw.ger()* to determine the recommended data point to use.

The **adaptive** argument will be designated as **TRUE.**
...
### 7.1.2 Computing the adaptive bandwidth gwr model
