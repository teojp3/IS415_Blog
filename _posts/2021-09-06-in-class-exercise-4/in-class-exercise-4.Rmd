...
```{r}
sg_sf <- st_read(dsn = "ice4data/shapefile", layer="CostalOutline")

mpsz_sf <- st_read(dsn = "ice4data/shapefile", layer = "MP14_SUBZONE_WEB_PL")
```
## Importing Aspatial Data

```{r}
childcare <- read_rds("ice4data/rds/childcare.rds")
CHAS <- read_rds('ice4data/rds/CHAS.rds')
```
