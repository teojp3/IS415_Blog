...
packages = c('tidyverse', 'sf', 'readxl', 'readr', 'stringr', 'tmap', 'lemon', 'formatR', 'ggplot2')
for (p in packages)
  {
...
![Visualisation of Case_Rate_Rds](CaseRateRds.png)
![Visualisation of Death_Rate_Rds](DeathRateRds.png)
