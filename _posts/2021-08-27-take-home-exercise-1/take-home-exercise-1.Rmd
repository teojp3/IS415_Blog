...
### 4.3.1 Plotting Percentile Map to visualise extreme values
...
### 4.3.2 Plotting BoxMap to visualise outliers
...
The concept of a Standardised Mortality Rate (SMR) or also known as Relative Risk, is a commonly used metric in public health analysis. Through this SMR, we can see the various indicated risk levels the sub-districts of Jakarta are parked under, based on the data we analysed.  
