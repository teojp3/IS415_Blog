...
coordinates(airbnb_2021)=c('longitude', 'latitude')
proj4string(airbnb_2021) <- CRS("+proj=longlat +ellps=WGS84 +datum=WGS84 +no_defs")
...
coordinates(tourist_attractions)=c('LONGTITUDE', 'LATITUDE')
proj4string(tourist_attractions) <- CRS("+proj=longlat +ellps=WGS84 +datum=WGS84 +no_defs")
```
