...
write.csv(hawker_centres, "data/the2data/hawker_centres.csv", row.names = FALSE)
```

Importing in the hawker_centres again

```{r}
hawker_centres <- read_csv(file = "data/the2data/hawker_centres.csv")
```
