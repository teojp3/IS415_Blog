...
write.csv(hawker_centres, "_posts/2021-09-19-take-home-exercise-2/the2data/hawker_centres.csv", row.names = FALSE)
```
...
```{r}
mrt_sf <- st_read(dsn = "_posts/2021-09-19-take-home-exercise-2/the2data/MRT", 
                layer = "MRTLRTStnPtt")
```
