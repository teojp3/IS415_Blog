...
Specifying this "queen" argument is not necessary because the default is set to TRUE, meaning this function will return a list of first order neighbours using the Queen criteria. However, if you do not want to compute Queen spatial weights, you can set the arugment to FALSE too.
...
* From the given output:
  ...
  + Hence, we will reject the null hypothesis and say that the developments are not spatially independent AKA there are strong signs of clustering 
