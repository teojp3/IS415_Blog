...
Due to the emergence of COVID-19, the study also uncovered the negative impact on the distribution of Airbnb listings in Singapore; such as **lowering the number of Entire Home/Apt room type units per km square** from 2019 to 2021, with **28.41 and 11.7 units per km square** respectively for those years.

This is not surprising as the COVID-19 pandemic has caused [devastating economic consequences on a world-wide scale](https://www.bbc.com/news/business-51706225), however we should press on and learn to cohabit with the COVID-19 virus, then work together to achieve economic success for our country again. 
