...
```{r results='hide'}
airbnb_2019 <- read_csv("_posts/2021-09-20-take-home-exercise-2/the2data/airbnb2019.csv")
airbnb_2021 <- read_csv("_posts/2021-09-20-take-home-exercise-2/the2data/airbnb2021.csv")
sg_hotels <- read_csv("_posts/2021-09-20-take-home-exercise-2/the2data/OneMapData/hotels.csv") 
tourist_attractions <- read_csv("_posts/2021-09-20-take-home-exercise-2/the2data/OneMapData/tourism.csv")
```
...
write.csv(hawker_centres, "_posts/2021-09-20-take-home-exercise-2/the2data/hawker_centres.csv", row.names = FALSE)
```
...
```{r}
hawker_centres <- read_csv(file = "_posts/2021-09-20-take-home-exercise-2/the2data/hawker_centres.csv")
```
...
```{r}
mrt_sf <- st_read(dsn = "_posts/2021-09-20-take-home-exercise-2/the2data/MRT", 
                layer = "MRTLRTStnPtt")
```
...
```{r}
sg <- st_read(dsn = "_posts/2021-09-20-take-home-exercise-2/the2data/sgdata", layer="CostalOutline")
